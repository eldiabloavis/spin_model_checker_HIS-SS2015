...
#ifndef NOCLAIM
	case 7:	/* claim select */
		spin_c_typ[0] = 5; /* property4 */
		((P7 *)pptr(h))->c_cur[0] = 3;
		reached5[3]=1;
		spin_c_typ[1] = 4; /* property3 */
		((P7 *)pptr(h))->c_cur[1] = 5;
		reached4[5]=1;
		spin_c_typ[2] = 3; /* property2 */
		((P7 *)pptr(h))->c_cur[2] = 8;
		reached3[8]=1;
		spin_c_typ[3] = 2; /* property1 */
		((P7 *)pptr(h))->c_cur[3] = 6;
		reached2[6]=1;
		((P7 *)pptr(h))->_t = 2;
		((P7 *)pptr(h))->_p = 6;
		((P7 *)pptr(h))->_n = 3; /* property1 */
		src_claim = src_ln2;
#ifndef BFS
		if (whichclaim == -1 && claimname == NULL)
			printf("0: Claim property1 (2), from state 6\n");
#endif
		if (whichclaim != -1)
